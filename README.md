...
![Desktop navbar](documentation/images/navbar-desktop.png)

![Desktop navbar with hover](documentation/images/navbar-hover-desktop.png)

![Tablet navbar](documentation/images/navbar-tablet.png)

![Mobile navbar](documentation/images/navbar-mobile.png)
...
![Portfolio Title](documentation/images/title-1.png)

![Packages & Prices Title](documentation/images/title-2.png)

![Reviews Title](documentation/images/title-3.png)

![About Title](documentation/images/title-4.png)
...
![Gallery View Desktop](documentation/images/gallery.png)

* Tablet View (maximum screen size of 960px)

![Portfolio Tablet](documentation/images/portfolio-tablet.png)

![Gallery View Tablet](documentation/images/gallery-tablet.png)

* Mobile View (maximum screen size of 480px)

![Portfolio Mobile](documentation/images/portfolio-mobile.png)
...
![Packages Desktop](documentation/images/packages-desktop.png)

* Tablet View

![Packages Tablet](documentation/images/packages-tablet.png)

* Mobile View

![Packages Mobile](documentation/images/packages-mobile.png)
...
![Types of photoshoots Desktop](documentation/images/photoshoot-desktop.png)

* Tablet View

![Types of photoshoots Tablet](documentation/images/photoshoot-tablet.png)
...
![About Page Desktop View](documentation/images/about.png)

* Tablet View 

![About Page Tablet View](documentation/images/about-tablet.png)
